...
// Setup paths for file database (configurable via process.env.DB_DIR for test isolation)
...
// Database helper functions for stats
function readStats() {
  try {
    ensureDatabase();
...
// Database helper functions for stats writing
